...
int main()
{
    ...
    std::ifstream f("/home/chenyl/CLionProjects/untitled1/coco.names");
    std::string name = "";
    ...
    cv:: VideoCapture cap;
    cv::Mat frame, img;
    frame = cap.open("/home/chenyl/CLionProjects/untitled1/output_test_1122.avi");
